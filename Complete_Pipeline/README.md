...
**Q: Can I run only specific experiments?**  
A: Yes! Set skip flags in the notebook (e.g., `SKIP_BASELINE = True`) to load pre-trained models.

**Q: How long does each experiment take?**  
A: 12-18 hours per experiment on a V100 GPU. Total: 60-70 hours for all 4.

**Q: Can I use CPU instead of GPU?**  
A: Technically yes, but it will take weeks instead of days. GPU is strongly recommended.

**Q: Where can I download pre-trained models?**  
A: Check the [main README](../README.md#research-artifacts) for Google Drive links.

**Q: What if I get different results?**  
A: Results may vary ±1-2 dB due to random initialization and training stochasticity.

**Q: Can I use my own scenes?**  
A: Yes! See [Experiments/custom_scenes.ipynb](../Experiments/) for instructions on using custom data.
...
- **Institution:** ITMO University, Robotics & AI Program

**For bug reports or feature requests:**  
Open an issue at: https://github.com/ayanali827/depth-supervised-nerf-notebooks/issues
